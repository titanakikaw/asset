                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="input-group input-group-sm mb-3">
                            ...
                            <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="data[cat_code]" value="<?php echo $cat_auto ?>" <?php echo $disabled ?>>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-group input-group-sm mb-3">
